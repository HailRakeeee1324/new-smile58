...
export const routeMeta = {
  home: { title: "Стоматология в Пензе — Новая улыбка | 3 филиала", description: "Стоматология «Новая улыбка» в Пензе: лечение зубов, имплантация, протезирование, удаление и профессиональная гигиена. Три филиала в Спутнике и на ГПЗ. Цены и запись на сайте.", path: "/" },
