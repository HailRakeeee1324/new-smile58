...
const heroBranches = [
  { name: "Светлая 11", area: "Спутник", phone: "8 (999) 000-00-01", href: `${routePaths.branches}?branch=svetlaya` },
  { name: "Радужная 10", area: "Спутник", phone: "8 (999) 000-00-02", href: `${routePaths.branches}?branch=raduzhnaya` },
  { name: "Антонова 76", area: "ГПЗ", phone: "8 (999) 000-00-03", href: `${routePaths.branches}?branch=antonova` },
];

const homeCards = [
  {
    icon: <Building2 />,
    title: "Ближайший филиал — без долгого поиска",
    text: "Две клиники в Спутнике и одна на ГПЗ: подберём адрес, где удобнее начать лечение и записаться быстрее.",
    route: "branches",
  },
  {
    icon: null,
      ...
      <section className="features container" aria-label="Преимущества">
        ...
        <div className="features__grid">
          {regularCards.map((card) => {
            ...
            return (
              <CardTag className={`feature-card feature-card--secondary reveal-on-scroll ${card.route ? "feature-card--clickable" : ""}`} key={card.title} {...cardProps}>
    ...
    <main className="page">
      ...
      <section className="container services-grid">
        {services.map((service) => (
          <article className="service-card service-card--wow reveal-on-scroll" key={service.title}>
            <div className={`service-card__image service-card__image--${service.tone}`}>
              <img src={service.image} alt={service.title} loading="lazy" decoding="async" />
              <div className="service-card__shade" />
            </div>
            <div className="service-card__body">
              <div className="service-card__image-caption">
      ...
      <section className="container seo-structure-block reveal-on-scroll">
        ...
        <p>Для Яндекса и пациентов каждая важная услуга получила свою посадочную страницу: так проще найти нужное лечение и быстрее записаться.</p>
      ...
      <section className="container page-cta">
        <div>
          ...
          <p>Запишитесь на консультацию — врач оценит ситуацию и предложит понятный план лечения.</p>
        </div>
  ...
  return (
    <main className="page service-seo-page local-seo-page">
      <section className="service-landing-hero local-landing-hero">
        <div className="container service-landing-hero__grid">
          <div className="service-landing-hero__content">
      ...
      <section className="container service-content-grid">
        <article className="service-info-block reveal-on-scroll">
          <p className="section-label">Для Яндекса и пациента</p>
          <h2>Что есть на странице</h2>
    ...
    <main className="page service-seo-page">
      <section className="service-landing-hero">
        <div className="container service-landing-hero__grid">
          ...
          <figure className="service-landing-hero__photo">
            <img src={page.image} alt={page.label} loading="eager" decoding="async" />
          </figure>
        </div>
      </section>
      ...
      <section className="container service-price-card reveal-on-scroll">
        <div>
          ...
          <p>Точная стоимость зависит от объёма лечения. Врач объясняет план до начала работ.</p>
        </div>
...
function ReviewsPage() {
  ...
  return (
    <main className="page seo-page reviews-page reviews-page--carousel reviews-page--simple">
      ...
      <section className="container page-cta seo-page-cta reviews-final-cta reviews-final-cta--clean">
        <div>
          <p className="section-label">ПроДокторов</p>
          <h2>Больше отзывов — на независимой площадке</h2>
          <p>Можно открыть внешний профиль клиники и посмотреть дополнительные отзывы пациентов.</p>
        </div>
        <a className="blue-link" href="https://prodoctorov.ru/penza/lpu/102261-novaya-ulybka/" target="_blank" rel="noreferrer" data-metrika-goal={METRIKA_GOALS.prodoctorovClick}>Открыть профиль</a>
      </section>
    </main>
  );
}
...
function BlogPage() {
  ...
  return (
    <main className="page seo-page blog-page blog-page--stable">
      <PageIntro
        label="Блог"
        title="Полезные статьи о стоматологии"
      />

      <section className="container blog-grid blog-grid--seo">
        {articles.map(([key, article], index) => (
          <article className="blog-card reveal-on-scroll" key={key}>
  ...
  return (
    <main className="page">
      <PageIntro
        ...
        text="Позвоните в клинику или выберите удобный филиал. Администратор подскажет ближайшее свободное окно и поможет сориентироваться по услугам."
      />

      <section className="container contacts-layout contacts-layout--wow">
        <div className="contact-panel contact-panel--main reveal-on-scroll">
          <Phone size={26} />
          <h2><a href={PHONE_LINK} data-metrika-label="Телефон на странице контактов">{PHONE}</a></h2>
        ...
        <div className="contact-panel reveal-on-scroll">
          <Clock size={26} />
          <h2>График работы</h2>
          <p>Пн–Пт 09:00–21:00, Сб 09:00–14:00, Вс — выходной.</p>
        </div>

        <div className="contact-panel reveal-on-scroll">
          <MapPin size={26} />
          <h2>3 филиала</h2>
          <p>Светлая 11, Радужная 10 и Антонова 76 — выбирайте удобный район.</p>
          <a className="blue-link" href={routePaths.branches} data-route-link>Открыть филиалы</a>
        </div>
      </section>
    </main>
  );
  ...
  return (
    <div className="appointment-modal" role="dialog" aria-modal="true" aria-labelledby="appointment-modal-title">
      ...
      <div className="appointment-modal__card">
        ...
        <form className="appointment-form" onSubmit={handleSubmit} data-metrika-form="appointment_modal">
          <label>
            <span>Имя</span>
          ...
          <button type="submit" disabled={submitState === "sending"}>{submitState === "sending" ? "Отправляем..." : "Отправить заявку"}</button>
          <small className={`appointment-form__status appointment-form__status--${submitState}`} aria-live="polite">
            {submitMessage || (formSent ? "Спасибо! Заявка отправлена." : "Нажимая кнопку, вы соглашаетесь на обработку персональных данных.")}
          </small>
        </form>
      </div>
    </div>
